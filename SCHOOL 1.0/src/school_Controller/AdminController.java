...
import school_classes.Etudiant;
...
public class AdminController implements Initializable {
   ...
   @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        colnumerotel.setCellValueFactory(new PropertyValueFactory<>("Telephone"));
  ...
  public void leadDatabaseData() throws SQLException{
            ...
            String query ="SELECT `id`,`nom`,`prenom`,`adresse`,`telephone`,`mail`, `classe` FROM `individu`";
